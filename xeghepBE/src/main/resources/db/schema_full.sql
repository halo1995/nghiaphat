...
CREATE INDEX idx_payment_attachments_reference ON payment_attachments(reference_type, reference_id);
CREATE INDEX idx_payment_attachments_expires ON payment_attachments(expires_at);
...
CREATE INDEX idx_company_transactions_wallet ON company_transactions(wallet_id, created_at DESC);
...
CREATE INDEX idx_expense_vouchers_category ON expense_vouchers(category);
CREATE INDEX idx_expense_vouchers_wallet ON expense_vouchers(wallet_id);
CREATE INDEX idx_expense_vouchers_created_at ON expense_vouchers(created_at DESC);

CREATE TABLE expense_voucher_history (
    id              BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_expense_voucher_history_voucher ON expense_voucher_history(voucher_id, action_at DESC);
